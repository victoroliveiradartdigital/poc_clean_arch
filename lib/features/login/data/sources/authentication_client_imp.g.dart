...
part of 'authentication_client_imp.dart';
...
class _AuthenticationClientImp implements AuthenticationClientImp {
  _AuthenticationClientImp(this._dio, {this.baseUrl});
